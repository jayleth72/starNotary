...
contract StarNotary is ERC721 {
  ...
  function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
    ...
    require(msg.sender == ownerAddress1 || msg.sender == ownerAddress2);
  ...
  function transferStar(address _to1, uint256 _tokenId) public {
    ...
    address originalStarOwner = ownerOf(_tokenId);
    require(msg.sender == originalStarOwner);
    _transferFrom(originalStarOwner, _to1, _tokenId);
  }
}
